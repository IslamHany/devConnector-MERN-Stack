    ...
    return(
        <Fragment>
            ...
            <form className="form" onSubmit={(e) => onSubmit(e)}>
                ...
                <div className="form-group">
                    <input onChange={(e) => onChange(e)} type="text" placeholder="Company" name="company" value={company} />
                    <small className="form-text"
                        >Could be your own company or one you work for</small
                        >
                </div>
                <div className="form-group">
                    <input onChange={(e) => onChange(e)} type="text" placeholder="Website" name="website" value={website}/>
                    <small className="form-text"
                        >Could be your own or a company website</small
                        >
                </div>
                <div className="form-group">
                    <input onChange={(e) => onChange(e)} type="text" placeholder="Location" name="location" value={location} />
                    <small className="form-text"
                        >City & state suggested (eg. Boston, MA)</small
                        >
                </div>
                <div className="form-group">
                    <input onChange={(e) => onChange(e)} type="text" placeholder="* Skills" name="skills" value={skills}/>
                    <small className="form-text"
...
const mapDispatchToProps = dispatch => {
    return{
        onCreateProfile: (FormData, history, edit) => dispatch(createProfile(FormData, history, edit))
    };
};
