        ...
        <Fragment>
            ...
            <form className="form" onSubmit={e => {
                ...
                <div className="form-group">
                    <input type="text" placeholder="* School ot Bootcamp" name="school" value={school} onChange={(e) => onChange(e)} required />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                    <h4>To Date</h4>
                    <input type="date" disabled={toDateDisabled ? 'disabled' : ''} name="to" value={to} onChange={(e) => onChange(e)}/>
                </div>
                <div className="form-group">
                    <textarea
                        name="description"
